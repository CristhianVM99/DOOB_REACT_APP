...
export const getInstitucion = async () => {
    const res = await institucionAPI.get('/InstitucionUPEA/'+process.env.REACT_APP_ID_INSTITUCION)
    return res.data.Descripcion
}

export const getConvocatorias = async () => {
    const res = await institucionAPI.get('/convocatoriasAll/'+process.env.REACT_APP_ID_CARRERA)
    return res.data
}

export const getCursos = async () => {
    const res = await institucionAPI.get('/cursosAll/'+process.env.REACT_APP_ID_CARRERA)
    return res.data
};

export const getLinksInstExtAll = async () => {
    const res = await institucionAPI.get('/linksIntExtAll/'+process.env.REACT_APP_ID_INSTITUCION)
    return res.data
}

export const getServicios = async () => {
    const res = await institucionAPI.get('/ServicioAll/'+process.env.REACT_APP_ID_CARRERA)
    return res.data
}

export const getOfertasAcademicas = async () => {
    const res = await institucionAPI.get('/OfertasAcademicasAll/'+process.env.REACT_APP_ID_CARRERA)
    return res.data
}

export const getPublicaciones = async () => {
    const res = await institucionAPI.get('/publicacionesAll/'+process.env.REACT_APP_ID_INSTITUCION)
    return res.data
}

export const getGacetas = async () => {
    const res = await institucionAPI.get('/gacetaunivAll/'+process.env.REACT_APP_ID_INSTITUCION)
    return res.data
}

export const getEventos = async () => {
    const res = await institucionAPI.get('/eventoAll/'+process.env.REACT_APP_ID_INSTITUCION)
    return res.data
}

export const getVideos = async () => {
    const res = await institucionAPI.get('/VideosAll/'+process.env.REACT_APP_ID_INSTITUCION)
    return res.data
}
