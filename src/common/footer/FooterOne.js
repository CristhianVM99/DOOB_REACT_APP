...
const FooterOne = () => {
    ...
    if (!loading_institucion && !loading_static_data) {
        ...
        /* DATOS ESTATICOS */
        const { txt_content_footer } = staticData;
                                        ...
                                        <div className="widget-menu-bottom">
                                            ...
                                            <div className="inner">
                                                <ul className="footer-link link-hover">
                                                    <li>
                                                        <Link
                                                            to={`/institucion/${TIPOS.CONVENIOS}`}
                                                        >
                                                            Convenios
                                                            Institucionales
                                                        </Link>
                                                    ...
                                                    <li>
                                                        <Link
                                                            to={`/institucion/${TIPOS.PASANTIAS}`}
                                                        >
                                                            Pasantías
                                                        </Link>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <Link
                                                            to={`/institucion/${TIPOS.INSTITUTO_INVESTIGACION}`}
                                                        >
                                                            Instituto de
                                                            Investigación
                                                        </Link>
                                        ...
                                        <div className="widget-menu-top">
                                            ...
                                            <div className="inner">
                                                <ul className="footer-link link-hover">
                                                    <li>
                                                        <Link
                                                            to={`/recursos/${TIPOS.CONVOCATORIAS}`}
                                                        >
                                                            Convocatorias
                                                        </Link>
                                                    </li>
                                        ...
                                        <div className="widget-menu-bottom">
                                            ...
                                            <div className="inner">
                                                <ul className="footer-link link-hover">
                                                    ...
                                                    <li>
                                                        <Link
                                                            to={`/recursos/${TIPOS.OFERTAS_ACADEMICAS}`}
                                                        >
                                                            Ofertas Académicas
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link
                                                            to={`/recursos/${TIPOS.PUBLICACIONES}`}
                                                        >
                                                            Publicaciones
                                                        </Link>
                                                    </li>
