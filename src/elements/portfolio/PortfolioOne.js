...
const PortfolioOne = ({ Column, institucion = null, gacetas= null, publicaciones = null, categoria = null }) => {
    ...
    /* FILTRADOE DE CONVENIOS PARA GACETAS DE TIPO TRABAJO DIRIGIDO */
    const filterinstitucion = gacetas.filter((e) => e.gaceta_titulo.includes(TIPOS.INSTITUTO));
    ...
    const handleChange = (e) => {
        ...
        let tempData;
        if (e.target.textContent.toUpperCase() === filters[0].text.toUpperCase()) {
          tempData = getAllItems;
        } else {
          tempData = getAllItems.filter(
            (data) =>
              data.category === e.target.textContent.toUpperCase()              
          );
        }
        setVisibleItems(tempData);
    };
                    ...
                    <div className="col-lg-12">
                        <ul className="rwt-portfolio-filter filter-button-default liststyle mb--20">
                            ...
                            <li className="list-item" key={filter.id}>
                                ...
                                className={
                                    filter.text.toUpperCase() === categoria
                                    ? "current"
                                    : " "
                                }
                                >
